...
return [
    ...
    'access_cp' => 'Đăng nhập Bảng điều khiển',
    ...
    'group_collections' => 'Tổng hợp dữ liệu',
    'configure_collections' => 'Cài đặt bộ dữ liệu',
    ...
    'edit_{collection}_entries' => 'Chỉnh sửa các Bản ghi',
    'create_{collection}_entries' => 'Tạo mới Bản ghi',
