...
return [
    'activate_account_notification_body' => 'Bạn nhận được email này bởi vì chúng tôi nhận được yêu cầu thay đổi mật khẩu cho tài khoản của bạn.',
    'activate_account_notification_subject' => 'Kích hoạt tài khoản',
    ...
    'collection_configure_date_behavior_public' => 'Công khai - luôn luôn hiển thị',
    'collection_configure_date_behavior_unlisted' => 'Unlisted - Hidden from listings, URLs visible',
    'collection_configure_dated_instructions' => 'Bạn có thể tùy chỉnh thời gian xuất bản hoặc hết hạn cho Bản ghi của Loại dữ liệu này',
    ...
    'collection_configure_title_instructions' => 'Nếu bạn sử dụng ngôn ngữ nước ngoài, chúng tôi khuyến khích sử dụng các từ số nhiều như: "Articles" or "Products".',
    'collection_next_steps_configure_description' => 'Cài đặt đường dẫn, định tuyến, lựa chọn Hình thái dữ liệu, cấu hình kế hoạch xuất bản, sắp xếp và các lựa chọn khác.',
    ...
    'collections_route_instructions' => 'Mô tả định tuyến để xem được Bản ghi.',
    ...
    'field_validation_required_instructions' => 'Người dùng có bắt buộc phải nhập trường này không.',
    ...
    'form_configure_title_instructions' => 'Thông thường dùng để kêu gọi hành động, ví dụ như "Liên hệ tư vấn".',
    'getting_started_widget_blueprints' => 'Hình thái dữ liệu dùng để định nghĩa và sắp xếp các trường các trường, mà từ đó dùng để khởi tạo và lưu nội dung.',
    'getting_started_widget_collections' => 'Loại dữ liệu là một phương pháp để phân chia nội dung, dữ liệu của website bạn một cách tốt nhất.',
    'getting_started_widget_docs' => 'Xem qua tài liệu chính thức của Statamic là cách tốt nhất để hiểu rõ về các tính năng của nền tảng này',
    'getting_started_widget_header' => 'Chào mừng đến với Statamic 3',
    'getting_started_widget_intro' => 'Để bắt đầu dựng website cùng vời Statamic 3, chúng tôi khuyến khích bạn thực hiện các bước sau:',
    'getting_started_widget_navigation' => 'Tạo ra các bộ phận nội dung có cấu trúc, có phân cấp, ví dụ: thanh menu, các đường dẫn điều hướng.',
    'getting_started_widget_pro' => 'Tính năng Pro sẽ có thêm các tính năng sau: không giới hạn người dùng, vai trò, quyền, tích hợp Git, lịch sử lưu, mạng lưới web và nhiều hơn nữa...',
    'git_disabled' => 'Tính năng tích hợp với Git hiện tại đang không được kích hoạt.',
    'git_nothing_to_commit' => 'Không có gì để commit, đường dẫn nội dung sạch!',
    'git_utility_description' => 'Manage Git tracked content.',
    'global_search_open_using_slash' => 'Kích hoạt tính năng tìm kiếm toàn cục bằng cách gõ phím <kbd>/</kbd>',
    ...
    'licensing_error_no_domains' => 'Không thể xác định tên tên miền',
